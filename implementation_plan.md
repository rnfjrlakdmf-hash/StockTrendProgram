...
### [MODIFY] [객관적 데이터 지표 정의 가이드]
- **목적**: 유사투자자문업 규제 준수를 위해 주관적 판단을 배제하고, ETF 구성의 기술적 지표들을 객관적으로 설명합니다.
- **주요 내용**: 
    - **운용보수(TER)**: "펀드가 자산 운용을 위해 투자자로부터 차감하는 연간 비용 비율입니다."
    - **순자산총액(AUM)**: "펀드가 보유한 자산의 총 합계로, 펀드의 운용 규모를 나타내는 지표입니다."
    - **거래량(Volume)**: "당일 시장에서 체결된 주식의 총 수량으로 시장의 유동성을 보여줍니다."
    - **괴리율/추적오차**: "ETF의 순자산가치(NAV)와 실제 시장 가격 간의 차이율을 의미합니다."
- **원칙**: "추천", "권장", "주의" 등의 단어를 배제하고 "지표의 정의와 역할"에만 집중합니다.
- ✅ **[완료]** 개미 vs AI (Sentiment Battle) 기능
- ✅ **[완료]** All-Asset View (주식 + 코인 + 환율 통합) 기능
- ✅ **[완료]** AI 뉴스 숏폼 (Financial TikTok) 기능
- ✅ **[완료]** 어닝 서프라이즈 알리미 (Earnings Whisper) 기능
