...
def generate_market_post(market_type):
    ...
    if market_type == "kor":
        ...
        작성 가이드:
        1. 맨 첫 줄에 반드시 사람들의 클릭을 유도할 수 있는 SEO 최적화된 매력적인 제목(예: "삼성전자 급등 이유 및 {today_str} 코스피 마감 시황")을 <title-seo>여기에 작성</title-seo> 형태로 출력하세요.
        ...
        작성 가이드:
        1. 맨 첫 줄에 반드시 사람들의 클릭을 유도할 수 있는 SEO 최적화된 매력적인 제목(예: "엔비디아 폭등 이유 및 {today_str} 미 증시 마감 시황")을 <title-seo>여기에 작성</title-seo> 형태로 출력하세요.
        2. 본문 첫 제목은 `<h2 class="text-2xl font-bold text-white pb-2 border-b border-gray-700 mb-6">🚀 [SEO제목 그대로 삽입]</h2>` 로 작성하세요.
