        ...
        try:
            ...
            if naver_info:
                ...
                final_data = {
                    ...
                    "is_extended_hours": naver_info.get('is_extended_hours', False),
                    "extended_price": naver_info.get('extended_price'),
                    "extended_change": naver_info.get('extended_change'),
                    "extended_change_percent": naver_info.get('extended_change_percent'),
