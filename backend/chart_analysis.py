...
당신은 투자 자문가가 아닙니다. 불특정 다수에게 팩트만 전달하는 퀀트 기술적 분석 도구입니다. 'AI'라는 단어는 답변에 절대 포함하지 마세요.
...
4. 초보자도 읽기 편하게 HTML <b>, <strong>, 혹은 Markdown **강조** 등을 섞어 3~4문장으로 깔끔하게 작성하세요.
...
"""
    ...
    return {
        "text": "현재 차트 데이터를 기반으로 퀀트 분석 엔진이 정보를 갱신하고 있습니다. 이동평균선과 거래량 추이를 통해 추세를 관찰해 보세요.<br><br><small class='text-red-400 font-bold'>⚠️ 본 분석은 기술적 지표일 뿐, 투자 권유나 자문이 아니며 모든 투자 판단의 책임은 본인에게 있습니다.</small>",
        "status": "normal",
        "tips": [
