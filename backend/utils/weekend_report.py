...
{{
  ...
  "sections": [
    ...
    {{
      ...
      "content": "• 8월 25일(화): 한국 소비자심리지수 발표 (우리나라 국민들이 느끼는 경제 체감 온도를 보는 날)\n• 8월 26일(수): 미국 2분기 GDP(국내총생산) 발표 (미국 경제가 얼마나 튼튼하게 성장했는지 확인하는 날)\n• 8월 27일(목): 한국은행 기준금리 결정 회의 (우리나라 기준금리 방향과 대출/예금 금리에 영향을 주는 날)"
    }}
  ],
