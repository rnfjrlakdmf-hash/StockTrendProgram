    ...
    if (!user) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[70vh] p-4 text-center">
                ...
                <p className="text-gray-300 mb-6 text-sm">기관/외국인 수급과 퀀트 알파 분석을 열람하려면 로그인이 필요합니다.</p>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-[#07080d] text-gray-100 p-4 md:p-8 max-w-5xl mx-auto relative overflow-hidden font-sans">
            ...
            <div className="relative mb-8 pb-6 border-b border-white/10">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        <div className="relative p-3.5 bg-gradient-to-br from-amber-400 via-amber-500 to-amber-700 rounded-2xl shadow-[0_0_30px_rgba(245,158,11,0.35)] text-black font-black flex items-center justify-center shrink-0">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-1.5">
                                <span className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full text-[11px] font-black uppercase tracking-wider bg-amber-500/20 text-amber-300 border border-amber-500/40">
                            ...
                            <p className="text-xs md:text-sm text-gray-300 mt-1 font-medium">
                                한국거래소(KRX) 공식 외국인·기관 순매수 상위 종목 및 거대 자금 이동 심층 분석
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 self-start md:self-center shrink-0">
                        {report?.locked ? (
                            <div className="bg-rose-500/15 text-rose-300 text-xs font-black px-4 py-2.5 rounded-2xl border border-rose-500/40 flex items-center gap-1.5 shadow-[0_0_20px_rgba(244,63,94,0.15)]">
                                <Lock className="w-3.5 h-3.5" />
                                VVIP 전용 잠금
                            </div>
                        ) : (
                            <div className="bg-emerald-500/15 text-emerald-300 text-xs font-black px-4 py-2.5 rounded-2xl border border-emerald-500/40 flex items-center gap-1.5 shadow-[0_0_20px_rgba(16,185,129,0.15)]">
                                <Unlock className="w-3.5 h-3.5" />
                                열람 권한 활성화
                            </div>
                        )}
                        {!report?.locked && timeLeft && (
                            <div className="flex items-center gap-2 text-xs md:text-sm font-mono tabular-nums bg-amber-500/15 backdrop-blur-md px-3.5 py-2.5 rounded-2xl border border-amber-500/40 text-amber-200 shadow-[0_0_20px_rgba(245,158,11,0.15)]">
                                <Timer className="w-3.5 h-3.5 text-amber-400 animate-pulse" />
                                <span className="font-black tracking-wider">{timeLeft}</span>
                                <span className="text-[11px] text-amber-300 font-sans">남음</span>
                            </div>
                        )}
                    </div>
                </div>
            ...
            {isLoading ? (
                ...
                <div className="space-y-8">
                    ...
                    {report.locked ? (
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="relative bg-gradient-to-br from-zinc-900/95 via-zinc-950 to-zinc-950 border border-amber-500/30 rounded-3xl p-6 md:p-8 shadow-2xl overflow-hidden space-y-5">
                                ...
                                <div className="flex items-center justify-between gap-3 pb-3 border-b border-white/10">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-300">외인·기관 거대 자금의 섹터 로테이션 및 집중 이동 흐름</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="relative rounded-3xl overflow-hidden border border-amber-500/30 p-8 md:p-12 bg-gradient-to-b from-zinc-900/95 via-zinc-950 to-zinc-950 shadow-2xl flex flex-col items-center justify-center text-center">
                                ...
                                <p className="text-xs md:text-sm text-gray-200 max-w-lg mb-6 leading-relaxed font-medium">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full max-w-xl mb-8">
                                    <div className="bg-zinc-900/90 border border-amber-500/30 rounded-2xl p-3.5 text-left">
                                        <span className="text-amber-300 text-xs font-black block mb-1">🏆 퀀트 알파 3선</span>
                                        <p className="text-xs text-gray-300 leading-tight">수급+이평선+컨센서스 종합 1위</p>
                                    </div>
                                    <div className="bg-zinc-900/90 border border-cyan-500/30 rounded-2xl p-3.5 text-left">
                                        <span className="text-cyan-300 text-xs font-black block mb-1">🚀 내일 주도 테마</span>
                                        <p className="text-xs text-gray-300 leading-tight">소부장 & 핵심 밸류체인 분석</p>
                                    </div>
                                    <div className="bg-zinc-900/90 border border-emerald-500/30 rounded-2xl p-3.5 text-left">
                                        <span className="text-emerald-300 text-xs font-black block mb-1">🛡️ 헷지 & 리스크</span>
                                        <p className="text-xs text-gray-300 leading-tight">선물/인버스 포지션 방어선</p>
                                    </div>
                                </div>
                        ...
                        <div className="space-y-10">
                            ...
                            {(activeTab === 'all' || activeTab === 'pulse') && (
                                <section className="relative bg-gradient-to-br from-zinc-900/95 via-zinc-950 to-zinc-950 border border-amber-500/30 rounded-3xl p-6 md:p-8 shadow-2xl overflow-hidden space-y-6">
                                    ...
                                    <div className="flex items-center justify-between gap-3 pb-4 border-b border-white/10">
                                        <div className="flex items-center gap-3.5">
                                            ...
                                            <div>
                                                <span className="text-[11px] font-mono font-bold text-amber-400 tracking-widest block uppercase">
                                ...
                                <section className="space-y-6">
                                    <div className="flex items-center justify-between pb-3 border-b border-white/10">
                                        <div className="flex items-center gap-3.5">
                                            ...
                                            <div>
                                                <span className="text-[11px] font-mono font-bold text-cyan-400 tracking-widest block uppercase">
                                    ...
                                    {quantStocks.length > 0 ? (
                                            ...
                                            {quantStocks.map((stock, idx) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-white/10 mb-5">
                                                        ...
                                                        <span className="text-xs md:text-sm font-mono font-bold text-cyan-300 bg-cyan-500/15 border border-cyan-500/30 px-4 py-1.5 rounded-xl shadow-sm">
                                                            {stock.volume}
                                                        </span>
                                                    </div>
                                        ...
                                        <div className="prose prose-invert max-w-none text-sm text-zinc-100 bg-zinc-950/70 p-6 rounded-3xl border border-white/5 leading-relaxed">
                            ...
                            {(activeTab === 'all' || activeTab === 'catalyst') && (
                                <section className="relative bg-gradient-to-br from-purple-950/20 via-zinc-950 to-zinc-950 border border-purple-500/30 rounded-3xl p-6 md:p-8 shadow-2xl overflow-hidden space-y-6">
                                    ...
                                    <div className="flex items-center justify-between gap-3 pb-4 border-b border-white/10">
                                        <div className="flex items-center gap-3.5">
                                            ...
                                            <div>
                                                <span className="text-[11px] font-mono font-bold text-purple-400 tracking-widest block uppercase">
                            ...
                            {(activeTab === 'all' || activeTab === 'risk') && (
                                <section className="relative bg-gradient-to-br from-emerald-950/20 via-zinc-950 to-zinc-950 border border-emerald-500/30 rounded-3xl p-6 md:p-8 shadow-2xl overflow-hidden space-y-6">
                ...
                <div className="text-center text-gray-400 py-16 bg-zinc-950 rounded-3xl border border-white/5">
                    리포트 데이터를 불러올 수 없습니다.
                </div>
            )}

            {/* 자본시장법 준수 법적 면책 안내 */}
            <div className="mt-12 p-6 bg-zinc-950/90 border border-white/5 rounded-3xl text-xs text-gray-300 space-y-2">
