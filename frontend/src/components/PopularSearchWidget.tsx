  ...
  return (
    <div className="w-full bg-gradient-to-b from-zinc-900/90 via-zinc-900/90 to-zinc-950 border border-white/10 rounded-3xl overflow-hidden shadow-2xl backdrop-blur-md flex flex-col justify-between h-full group hover:border-white/20 transition-all duration-300">
      ...
      <div className="bg-zinc-950/80 border-b border-white/10 px-5 py-4 flex justify-between items-center gap-3">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black text-rose-400 border border-rose-500/40 px-1.5 py-0.2 rounded-md bg-rose-500/10">
              HOT
            </span>
          </div>
        </div>
            ...
            >
              <div className="flex items-center gap-2.5 min-w-0 flex-1">
                ...
                <div className={`w-6 h-6 flex-shrink-0 flex items-center justify-center rounded-lg font-black text-xs ${
                  idx === 0 ? "bg-gradient-to-br from-rose-500 to-red-600 text-white shadow-md shadow-rose-500/20" :
                  idx === 1 ? "bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-md" :
                  idx === 2 ? "bg-gradient-to-br from-amber-600 to-amber-700 text-amber-100 shadow-md" :
              ...
              <div className="flex flex-col items-end flex-shrink-0 ml-2">
                ...
                <div className="flex items-center gap-1 mt-0.5">
                  <div className={`px-2 py-0.5 rounded-md text-[10px] font-black font-mono border ${bgClass}`}>
                    {isUp ? `+${item.change_percent}%` : `${item.change_percent}%`}
                  </div>
                </div>
              </div>
            </Link>
      ...
      <div className="px-5 pb-3.5 pt-0.5 flex items-center justify-between text-[11px] text-gray-500">
        <span>국내 포털 실시간 검색 순위 연동</span>
        <span className="text-rose-400 font-semibold">30초 자동 갱신</span>
      </div>
