...
const navigationGroups = [
    {
        ...
        items: [
            ...
            { name: "장마감 수급 스캐너", href: "/signals?tab=scanner", icon: Flame, desc: "정규장 마감 수급 집중주 & 기술적 벤치마크선 도달 통계를 퀀트 알고리즘으로 추적합니다.", badge: "HOT" },
    ...
    },
    {
        groupName: "종목 발굴 & 분석",
        items: [
            { name: "5대 안전벨트 진단기", href: "/signals?tab=safety", icon: ShieldCheck, desc: "초보자를 위한 종목 5대 팩트 체크(실적/가치/수급/과열/부채) 100점 만점 자가진단기입니다.", badge: "NEW" },
