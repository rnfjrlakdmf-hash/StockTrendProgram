        ...
        <header className="flex flex-col md:flex-row items-center justify-between p-6 border-b border-white/5 bg-black/40 backdrop-blur-md sticky top-0 z-50 transition-all duration-200">
            ...
            <div className="flex items-center gap-4 w-full md:w-auto justify-end flex-shrink-0">
                ...
                <div className="flex items-center gap-2">
                    ...
                    {/* Discord Join Button */}
                    <a href="https://discord.gg/YOUR_DISCORD_INVITE_LINK" target="_blank" rel="noopener noreferrer" className="p-2 rounded-xl border border-[#5865F2]/30 bg-[#5865F2]/10 text-[#5865F2] hover:text-white hover:bg-[#5865F2] transition-all group relative flex items-center justify-center">
