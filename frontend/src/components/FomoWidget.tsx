        ...
        <AnimatePresence>
            {isVisible && currentItem && (
                ...
                >
                    ...
                    >
                        <div className="glass-card border border-primary-500/30 shadow-[0_8px_30px_rgba(59,130,246,0.2)] rounded-2xl p-4 cursor-pointer hover:border-primary-400/50 transition-all flex items-start gap-3 group">
                            <div className="flex-shrink-0 mt-0.5 p-2 bg-white/5 rounded-full group-hover:scale-110 transition-transform">
